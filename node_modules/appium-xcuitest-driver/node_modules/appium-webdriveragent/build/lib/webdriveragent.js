...
class WebDriverAgent {
    ...
    get bundleIdForXctest() {
        return this.updatedWDABundleId ? `${this.updatedWDABundleId}.xctrunner` : constants_1.WDA_RUNNER_BUNDLE_ID_FOR_XCTEST;
    }
    ...
    async isSourceFresh() {
        ...
        ].map((subPath) => support_1.fs.exists(path_1.default.resolve(this.bootstrapPath, subPath)));
