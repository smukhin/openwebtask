declare namespace _default {
     ...
     */
    function mobileGetPermission(this: import("../driver").default, bundleId: string, service: PermissionService): Promise<import("./types").PermissionState>;
    /**
     ...
     * @this {XCUITestDriver}
     */
    function mobileSetPermissions(this: import("../driver").default, access: Record<Partial<import("./types").AccessRule>, import("./types").PermissionState>, bundleId: string): Promise<void>;
}
