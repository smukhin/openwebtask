declare namespace _default {
     ...
     * @this {XCUITestDriver}
     */
    function mobilePushNotification(this: import("../driver").default, bundleId: string, payload: import("./types").PushPayload): Promise<any>;
    /**
     ...
     * @this {XCUITestDriver}
     */
    function mobileExpectNotification(this: import("../driver").default, name: string, type?: import("./types").NotificationType, timeoutSeconds?: number): Promise<unknown>;
}
