...
export namespace commands {
     ...
     * @this {XCUITestDriver}
     */
    function mobileGetSimulatedLocation(this: import("../driver").default): Promise<GeolocationInfo>;
    /**
     ...
     * @this {XCUITestDriver}
     */
    function mobileSetSimulatedLocation(this: import("../driver").default, latitude: number, longitude: number): Promise<void>;
    /**
     ...
     * @this {XCUITestDriver}
     */
    function mobileResetSimulatedLocation(this: import("../driver").default): Promise<void>;
}
