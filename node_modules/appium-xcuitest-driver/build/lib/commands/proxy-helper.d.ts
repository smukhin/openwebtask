declare namespace _default {
     ...
     */
    function proxyCommand<TReq = any, TRes = unknown>(this: import("../driver").default, url: string, method: AllowedHttpMethod, body?: TReq | undefined, isSessionCommand?: boolean): Promise<TRes>;
}
